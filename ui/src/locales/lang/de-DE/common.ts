export default {
  ...
  knowledgeImportTip: 'Wissensdatenbank erfolgreich importiert. Die Dokumente wurden noch nicht vektorisiert. Bitte konfigurieren Sie das Embedding-Modell und vektorisieren Sie die Dokumente.',
  import: 'Importieren',
}
