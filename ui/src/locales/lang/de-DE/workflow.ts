export default {
  ...
  setting: {
    ...
    defaultModelSettingTip: 'Knoten, die „Standardmodell“ auswählen, verwenden die folgende Konfiguration.',
    defaultModelNotConfigured: 'Standardmodell nicht konfiguriert',
    defaultModelUnavailable: 'Standardmodell nicht verfügbar',
    ...
    apply: 'Anwenden',
    applyToAllConfirmMsg: 'Bei allen Knoten wird die Modellquelle auf „Standardmodell“ gesetzt und überschreibt die aktuellen Einstellungen „Benutzerdefiniert / Referenzierend“. Bitte vorsichtig vorgehen.',
    applyToAllSuccess: '{count} Knoten auf Standardmodell gesetzt',
    applyToAllNone: 'Kein Knoten muss geändert werden',
