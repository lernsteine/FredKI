...
(2) Fügen Sie Ihre HTTP-Seite hinzu, z. B. http://127.0.0.1:8080.</p>`,
  ...
  uploadFile: {
    ...
    documentMessage: 'Bitte verarbeiten Sie den Dokumentinhalt',
    audioMessage: 'Bitte verarbeiten Sie den Audioinhalt',
	 videoMessage: 'Bitte verarbeiten Sie den VideoInhalt',
    otherMessage: 'Bitte verarbeiten Sie den Dateinhalt',
