export default {
  ...
  fileType: {
    ...
    table: {
      ...
      tip2: '2. Die erste Zeile muss Spaltenüberschriften sein, die sinnvolle Begriffe enthalten. Jeder Datensatz wird als ein Segment behandelt.',
      tip3: '3. Jeder Tabellenblatt in der hochgeladenen Datei wird als separates Dokument behandelt, der Blattname dient als Dokumentname.',
      tip4: '4. Bis zu 50 Dateien können gleichzeitig hochgeladen werden, jede Datei darf 100 MB nicht überschreiten.',
    },
    QA: {
      label: 'QA-Paare',
      tip1: '1. Klicken Sie, um die entsprechende Vorlage herunterzuladen und auszufüllen:',
      tip2: '2. Jeder Tabellenblatt in der hochgeladenen Datei wird als separates Dokument behandelt, der Blattname dient als Dokumentname.',
  ...
  setRules: {
    ...
    advanced: {
      ...
      text: 'Benutzer können Trennzeichen, Segmentlänge und Bereinigungsregeln individuell an Dokumentstandards anpassen.',
    },
    patterns: {
  ...
  tag: {
    ...
    deleteTip:
      'Nach dem Löschen wird das Tag von allen Ressourcen entfernt, die es verwenden. Bitte mit Vorsicht fortfahren!',
  ...
  sync: {
    ...
    confirmMessage1:
      'Bei der Synchronisierung werden vorhandene Daten gelöscht und neue abgerufen. Bitte mit Vorsicht fortfahren.',
  ...
  delete: {
    ...
    confirmMessage:
      'Segmente in den ausgewählten Dokumenten werden ebenfalls gelöscht. Bitte mit Vorsicht fortfahren.',
    successMessage: 'Erfolgreich',
  ...
  generateQuestion: {
    ...
    successMessage: 'Erfolgreich',
    tip1: 'Das {data} im Prompt ist ein Platzhalter für segmentierten Inhalt, der beim Ausführen durch den segmentierten Inhalt ersetzt wird und an das AI-Modell gesendet wird;',
    tip2: 'Das AI-Modell generiert relevante Fragen basierend auf dem segmentierten Inhalt. Bitte platzieren Sie die generierten Fragen innerhalb der',
